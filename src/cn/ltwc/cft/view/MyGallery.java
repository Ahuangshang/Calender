...
//import com.candzen.zm.ui.activity.MainContentActivity;
//
///**
// * Created by huangshang on 15/12/19.
// */
...
//			float min_distance = MainContentActivity.screenWidth / 4f;
...
//
//			if ((int) width <= MainContentActivity.screenWidth
//					&& (int) height <= MainContentActivity.screenHeight)// 如果图片当前大小<屏幕大小，直接处理滑屏事件
//			{
...
//				if (distanceX > 0)// 向左滑动
//				{
//					if (r.left > 0 || right < MainContentActivity.screenWidth) {// 判断当前ImageView是否显示完全
//						super.onScroll(e1, e2, distanceX, distanceY);
//					} else {
...
//				{
//					if (r.right < MainContentActivity.screenWidth || left > 0) {
//						super.onScroll(e1, e2, distanceX, distanceY);
//					} else {
//						imageView.postTranslate(-distanceX, -distanceY);
//					}
...
//				if ((int) width <= MainContentActivity.screenWidth
//						&& (int) height <= MainContentActivity.screenHeight)// 如果图片当前大小<屏幕大小，判断边界
//				{
//					break;
//				}
//				float v[] = new float[9];
...
//				if (top < 0 && bottom < MainContentActivity.screenHeight) {
//					imageView.postTranslateDur(MainContentActivity.screenHeight - bottom, 200f);
//				}
//				if (top > 0 && bottom > MainContentActivity.screenHeight) {
...
//				if(left<0 && right< MainContentActivity.screenWidth){
//					imageView.postTranslateXDur(MainContentActivity.screenWidth
//							- right, 200f);
//				}
//				if(left>0 && right>MainContentActivity.screenWidth){
