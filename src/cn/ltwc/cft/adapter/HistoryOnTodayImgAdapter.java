...
public class HistoryOnTodayImgAdapter extends BaseAdapter {
	...
	public HistoryOnTodayImgAdapter(Context context, List<HistoryOnTodayImgBean> imgUrl) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		imageLoader.displayImage(imgUrl.get(position).getImgUrl(), holder.img, displayImageOptions);
		return convertView;
	}
